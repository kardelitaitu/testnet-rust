...
# Overview ⋅ Tempo
Abstract[](https://docs.tempo.xyz/protocol/tip403/spec#abstract)
----------------------------------------------------------------
...
Motivation[](https://docs.tempo.xyz/protocol/tip403/spec#motivation)
--------------------------------------------------------------------
...
Built-in Policies[](https://docs.tempo.xyz/protocol/tip403/spec#built-in-policies)
----------------------------------------------------------------------------------
...
Policy Types[](https://docs.tempo.xyz/protocol/tip403/spec#policy-types)
------------------------------------------------------------------------
...
Storage and State[](https://docs.tempo.xyz/protocol/tip403/spec#storage-and-state)
----------------------------------------------------------------------------------
...
Interface Definition[](https://docs.tempo.xyz/protocol/tip403/spec#interface-definition)
----------------------------------------------------------------------------------------
...
Usage with TIP-20 Tokens[](https://docs.tempo.xyz/protocol/tip403/spec#usage-with-tip-20-tokens)
------------------------------------------------------------------------------------------------
...
### Example Usage[](https://docs.tempo.xyz/protocol/tip403/spec#example-usage)
...
Solidity file:
https://raw.githubusercontent.com/tempoxyz/tempo/refs/heads/main/docs/specs/src/TIP403Registry.sol

RUST:
https://github.com/tempoxyz/tempo/tree/main/crates/precompiles/src/tip403_registry