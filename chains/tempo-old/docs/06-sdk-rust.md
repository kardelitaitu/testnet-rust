...
Install[](https://docs.tempo.xyz/sdk/rust#install)
--------------------------------------------------
...
Configure A Provider[](https://docs.tempo.xyz/sdk/rust#configure-a-provider)
----------------------------------------------------------------------------

To use the Tempo extension crate, you will need to create a `[Provider](https://docs.rs/alloy/latest/alloy/providers/trait.Provider.html)` using the `[TempoNetwork](https://tempoxyz.github.io/tempo/tempo_alloy/struct.TempoNetwork.html)`. This will enable the usage of Tempo specific types on the `[Provider](https://docs.rs/alloy/latest/alloy/providers/trait.Provider.html)` instance.
...
Use Actions[](https://docs.tempo.xyz/sdk/rust#use-actions)
----------------------------------------------------------
...
See the Alloy [documentation](https://alloy.rs/) or the `[Provider](https://docs.rs/alloy/latest/alloy/providers/trait.Provider.html)` docs for more examples.