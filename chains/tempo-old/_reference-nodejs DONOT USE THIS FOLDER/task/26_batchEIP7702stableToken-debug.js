import { batchTransferStableForWallet } from './26_batchEIP7702stableToken.js';
...
async function testBatchEIP7702() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 26 - Batch Transfer (Stable)${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await batchTransferStableForWallet(wallet, proxy, 'DEBUG', 0, false);
...
testBatchEIP7702().catch(console.error);
