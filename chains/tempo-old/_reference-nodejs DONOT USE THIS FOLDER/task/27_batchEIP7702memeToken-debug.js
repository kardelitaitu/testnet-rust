import { batchTransferMemeForWallet } from './27_batchEIP7702memeToken.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 27 - Batch EIP-7702 Meme${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await batchTransferMemeForWallet(wallet, proxy, 'DEBUG', 0, false);
