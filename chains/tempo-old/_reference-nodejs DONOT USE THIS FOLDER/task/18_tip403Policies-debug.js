import { manageTIP403PolicyForWallet } from './18_tip403Policies.js';
...
async function testTIP403Policies() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 18 - TIP-403 Policies${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await manageTIP403PolicyForWallet(wallet, proxy, 'DEBUG', 0, false);
...
testTIP403Policies().catch(console.error);
