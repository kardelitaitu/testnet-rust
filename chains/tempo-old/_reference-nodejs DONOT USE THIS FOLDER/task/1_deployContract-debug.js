import { deployRandomContract } from './1_deployContract.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 1 - Deploy Contract${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await deployRandomContract(wallet, proxy, 'DEBUG', 0);
