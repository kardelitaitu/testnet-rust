import { batchSendTransactionForWallet } from './34_batchSendTransaction.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 34 - Native Batch Transactions${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await batchSendTransactionForWallet(wallet, proxy, 'DEBUG', 0, false);
