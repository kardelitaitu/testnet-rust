import { getWallet, getWalletFiles, getPrivateKeyFromFile } from '../utils/wallet.js';
import { batchApproveSwapForWallet } from './17_batchEIP7702.js';
import { askPassword } from '../utils/helpers.js';
import { COLORS } from '../utils/constants.js';
import { TempoInspector } from '../utils/tempoInspector.js';

async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 17 - Batch EIP-7702${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await batchApproveSwapForWallet(wallet, proxy, 'DEBUG', 0, false);
