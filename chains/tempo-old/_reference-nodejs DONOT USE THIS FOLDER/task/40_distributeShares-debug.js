import { distributeShares } from './40_distributeShares.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 40 - Distribute Shares (System Token)${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await distributeShares(wallet, proxy, 'DEBUG', 0);
