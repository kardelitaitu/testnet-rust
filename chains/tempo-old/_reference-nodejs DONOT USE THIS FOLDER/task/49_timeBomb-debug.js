import { startTimeBomb } from './51_timeBomb.js';
...
async function main() {
    console.log(`  ${COLORS.fg.red}💣  DEBUG MODE: Task 51 - Time Bomb${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    // workerId: 'DEBUG', walletIndex: 0, silent: false, waitForDetonation: true
    await startTimeBomb(wallet, proxy, 'DEBUG', 0, false, true);
