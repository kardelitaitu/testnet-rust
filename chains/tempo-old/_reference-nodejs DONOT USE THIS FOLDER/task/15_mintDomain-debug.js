import { mintRandomDomainForWallet } from './15_mintDomain.js';
...
async function testMintDomain() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 15 - Mint Domain${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await mintRandomDomainForWallet(wallet, proxy, 'DEBUG', 0, false);
...
testMintDomain().catch(console.error);
