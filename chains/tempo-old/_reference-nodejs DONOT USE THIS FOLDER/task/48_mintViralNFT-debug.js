import { mintViralNFTForWallet } from './48_mintViralNFT.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 48 - Claim Viral NFT${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await mintViralNFTForWallet(wallet, proxy, 'DEBUG', 0, false);
