import { batchMultipleSwapsForWallet } from './24_batchEIP7702swap.js';
...
async function testBatchEIP7702() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 24 - Batch Swap (System)${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await batchMultipleSwapsForWallet(wallet, proxy, 'DEBUG', 0, false);
