import { swapRandomStableForWallet } from './5_swapStable.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 5 - Swap Stablecoin${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await swapRandomStableForWallet(wallet, proxy, 'DEBUG', 0);
