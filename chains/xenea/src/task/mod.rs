...
pub mod t60_nonce_repair;
pub mod t61_mint_meme;
pub mod t62_batch_send_meme;
pub mod t63_burn_meme;
...
pub use self::t57_eip7702_explore::XeneaEip7702ExploreTask;
pub use self::t58_verify_create2::VerifyCreate2Task;
pub use self::t59_deploy_factory::DeployFactoryTask;
pub use self::t60_nonce_repair::NonceRepairTask;
...
// Trait alias
pub type XeneaTask = dyn Task<TaskContext> + Send + Sync;
...
mod tests {
    ...
    #[test]
    fn test_exported_task_names_format() {
        let tasks: Vec<Box<XeneaTask>> = vec![
            ...
            Box::new(t57_eip7702_explore::XeneaEip7702ExploreTask),
            Box::new(t58_verify_create2::VerifyCreate2Task),
            Box::new(t59_deploy_factory::DeployFactoryTask),
            Box::new(t60_nonce_repair::NonceRepairTask),
            Box::new(t61_mint_meme::MintMemeTask),
            Box::new(t62_batch_send_meme::BatchSendCreatedMemeTask),
            Box::new(t63_burn_meme::BurnMemeTask),
        ];
