...
#[async_trait]
impl Task<TaskContext> for XeneaEip7702ExploreTask {
    fn name(&self) -> &str {
        "57_xeneaEip7702Explore"
    }
    ...
    async fn run(&self, ctx: TaskContext) -> Result<TaskResult> {
        ...
        messages.push("EIP-7702 Exploration on XENEA".to_string());
        ...
        let tx3 = TransactionRequest::new()
            .to(deployer_address)
            .data(multibyte)
            .gas(gas_limit)
            .gas_price(gas_price)
        ...
        let tx4 = TransactionRequest::new()
            .to(deployer_address)
            .data(invalid)
            .gas(gas_limit)
            .gas_price(gas_price)
        ...
        let tx5 = TransactionRequest::new()
            .to(deployer_address)
            .data(sstore)
            .gas(gas_limit)
            .gas_price(gas_price)
        ...
        messages.push("".to_string());
        messages.push("EIP-7702 TRANSACTION BEHAVIOR ON XENEA:".to_string());
        ...
        messages.push("- XENEA accepts but ignores EIP-7702 data".to_string());
        ...
        messages.push("- Contact XENEA team about EIP-7702 support".to_string());
