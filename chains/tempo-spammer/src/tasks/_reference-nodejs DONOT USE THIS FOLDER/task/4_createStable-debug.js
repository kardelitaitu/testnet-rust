...
async function testCreateStable() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 4 - Create Stable${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await createRandomStableForWallet(wallet, proxy, 'DEBUG', 0, false);
...
testCreateStable().catch(console.error);
