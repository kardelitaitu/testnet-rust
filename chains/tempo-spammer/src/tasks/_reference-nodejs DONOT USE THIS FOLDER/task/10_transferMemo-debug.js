import { transferMemoRandomForWallet } from './10_transferMemo.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 10 - Transfer with Memo${COLORS.reset}\n`);
    ...
    // 2. Execute Task
    const result = await transferMemoRandomForWallet(wallet, proxy, 'DEBUG', 0);
