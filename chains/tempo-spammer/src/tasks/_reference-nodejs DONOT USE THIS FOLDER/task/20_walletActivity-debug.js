import { walletActivityForWallet } from './20_walletActivity.js';
...
async function debugActivity() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 20 - Wallet Activity Statistics${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await walletActivityForWallet(wallet, proxy, 'DEBUG', 0, false);
