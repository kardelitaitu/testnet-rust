import { placeRandomLimitOrderForWallet } from './11_limitOrder.js';
...
async function testLimitOrder() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 11 - Limit Order${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await placeRandomLimitOrderForWallet(wallet, proxy, 'DEBUG', 0, false);
