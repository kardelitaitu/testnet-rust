import { multiSendDisperseSystemForWallet } from './28_multiSendDisperse.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 28 - MultiSend Disperse${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await multiSendDisperseSystemForWallet(wallet, proxy, 'DEBUG', 0, false);
