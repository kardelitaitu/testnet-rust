import { transferLaterRandomTokenForWallet } from './37_transferLater.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 37 - Transfer Later (Schedule)${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await transferLaterRandomTokenForWallet(wallet, proxy, 'DEBUG', 0);
