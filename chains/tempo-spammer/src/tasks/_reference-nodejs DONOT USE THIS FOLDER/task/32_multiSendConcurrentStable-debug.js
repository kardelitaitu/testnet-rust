import { multiSendConcurrentStableForWallet } from './32_multiSendConcurrentStable.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 32 - Concurrent MultiSend Stable${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await multiSendConcurrentStableForWallet(wallet, proxy, 'DEBUG', 0, false);
