import { batchMintStableForWallet } from './43_batchMintStable.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 43 - Batch Mint Stable${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await batchMintStableForWallet(wallet, proxy, 'DEBUG', 0);
