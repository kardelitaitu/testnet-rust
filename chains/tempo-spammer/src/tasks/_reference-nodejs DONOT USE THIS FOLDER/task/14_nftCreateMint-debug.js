import { createMintRandomNFTForWallet } from './14_nftCreateMint.js';
...
async function testNFTCreateMint() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 14 - NFT Create & Mint${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await createMintRandomNFTForWallet(wallet, proxy, 'DEBUG', 0, false);
...
testNFTCreateMint().catch(console.error);
