import { removeRandomLiquidityForWallet } from './12_removeLiquidity.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 12 - Remove Liquidity${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await removeRandomLiquidityForWallet(wallet, proxy, 'DEBUG', 0);
