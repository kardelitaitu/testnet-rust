import { sendRandomTokenForWallet } from './3_sendToken.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 3 - Send Token${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await sendRandomTokenForWallet(wallet, proxy, 'DEBUG', 0);
