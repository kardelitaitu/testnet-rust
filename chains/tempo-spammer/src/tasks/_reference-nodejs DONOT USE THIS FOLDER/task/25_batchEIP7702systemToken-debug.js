import { batchTransferSystemForWallet } from './25_batchEIP7702systemToken.js';
...
async function testBatchEIP7702() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 25 - Batch Transfer (System)${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await batchTransferSystemForWallet(wallet, proxy, 'DEBUG', 0, false);
