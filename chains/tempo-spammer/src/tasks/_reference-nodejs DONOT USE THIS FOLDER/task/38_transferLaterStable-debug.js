import { transferLaterStableForWallet } from './38_transferLaterStable.js';
...
async function main() {
    console.log(`  ${COLORS.fg.magenta}🐛  DEBUG MODE: Task 38 - Schedule Stable Transfer${COLORS.reset}\n`);
    ...
    // 2. Execute Task Once
    const result = await transferLaterStableForWallet(wallet, proxy, 'DEBUG', 0);
