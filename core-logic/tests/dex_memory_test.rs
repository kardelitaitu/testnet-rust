...
async fn test_database_get_all_deployed_counter_contracts() {
    ...
    db.log_counter_contract_creation("w1", "0x1111", 21894).await.unwrap();
    db.log_counter_contract_creation("w2", "0x2222", 21894).await.unwrap();
    db.log_counter_contract_creation("w3", "0x3333", 137).await.unwrap();
